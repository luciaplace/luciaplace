...
function searchaddress(){
  ...
  <body class="u-body u-xl-mode"><c:import url="/WEB-INF/views/include/top.jsp" />
    <section class="u-align-center u-clearfix u-section-1" id="sec-cc67">
     ...
     <form method="post" id="pupdateform" enctype="multipart/form-data" action="/petcare/update">
		<h3 style="margin-left:18%; margin-top:1%;"><b>펫케어 수정</b></h3>
		...
		<table border="1">
			...
			<tr>
				...
				<td><input name="paddress" id ="paddress" class="pp" value="${dto.paddress}" required><button type="button" style="margin-left: 1%;" onclick="searchaddress()" >우편번호 찾기</button><br>
			...
			<tr>
				...
				<td><input type="radio" value="개" id="dog" name="pkind" /> <label
					for="dog">개</label> <input type="radio" value="고양이" id="cat"
					name="pkind" /> <label for="cat">고양이</label> <input type="radio"
					value="토끼" id="rabbit" name="pkind" /> <label for="rabbit">토끼</label>
					<input type="radio" value="고슴도치" id="hedgehog" name="pkind" /> <label
					for="hedgehog">고슴도치</label> <input type="radio" value="그외"
					id="other" name="pkind" /> <label for="other">그외</label></td>
			</tr>
			<tr>
				<td class="orange">기간<span style="color:red">*</span></td>
				<td><input type="radio" value="1주" id="one" name="pperiod" /> <label
					for="one">1주</label> <input type="radio" value="2주" id="two"
			...
			<tr>
				...
				<td><input name="pprice" placeholder="수정할 총 요금을 원까지 기재해주세요."
					class="pp" value="${dto.pprice}"></td>
			</tr>
			<tr>
			<tr>
				<td class="orange">사진</td>
				<td><span id="preview"></span> <input type="file"
					class="form-control" id="roompic" name="roompic"
					aria-describedby="inputGroupFileAddon04" aria-label="Upload"
					multiple="multiple" accept="image/*"></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" align="center"><input type="submit"
					value="글 수정" id="btn"> <input type="reset" value="초기화"
					id="btn"></td>
			</tr>
		</table>
...
<script>
$("input[name='pkind'][value='${dto.pkind}']").prop("checked", true);

$("input[name='pperiod'][value='${dto.pperiod}']").prop("checked", true);
